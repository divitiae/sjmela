...
class ListingListFeatureContainer extends Component {
  ...
  renderContent = (id, item, isLoading, listFeature, type) => {
    ...
    if (
      listFeature === "__empty__" ||
      isEmpty(listFeature) ||
      listFeature[0] === "__empty__"
    ) {
      return null;
    }
    return (
                    ...
                    <TouchableOpacity onPress={this._handlePress(i)}>
                      {!isEmpty(i.oIcon) ? (
                        <IconTextMedium
                          ...
                          iconColor={
                            !!i.oIcon.color ? "#fff" : Consts.colorDark2
                          }
                          textStyle={{
                            color:
                              !!i.oIcon.color &&
                              typeof i.oIcon.color === "string"
                                ? i.oIcon.color
                                : Consts.colorDark2,
                          }}
                        />
                        ...
                        <P
                          style={{
                            fontSize: 12,
                            textDecorationLine:
                              i.unChecked === "yes" ? "line-through" : "none",
